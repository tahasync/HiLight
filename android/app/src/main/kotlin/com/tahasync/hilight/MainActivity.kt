...
import com.tahasync.hilight.torch.ChargingBridge
...
class MainActivity : FlutterActivity() {
    ...
    override fun configureFlutterEngine(flutterEngine: FlutterEngine) {
        ...
        // While the app is open it also hosts the charging bridge, so
        // charging effects work even without notification access granted.
